...
/**
 * Controller class for managing the returning book view.
 * Handles the input of user and book details and sends a return book request to the server.
 */
public class ReturningBookController {
    ...
    @FXML
    private Button submitButton; // Button to submit the return book request
     ...
     * Validates the input fields and sends a return book request to the server.
     */
    @FXML
    private void handleSubmitButtonAction() {
        ...
        ClientUI.chat.accept(new ClientMessage(details, "return"));
    }
